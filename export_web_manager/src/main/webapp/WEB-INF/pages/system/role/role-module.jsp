        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="table-box">
                    ...
                    <!--工具栏/-->
                    <!-- 树菜单 -->
                    <form name="icform" id="roleForm" method="post" action="/system/role/updateRoleModule.do">
...
<script type="text/javascript">
    ...
    $(function () {
        $.ajax({
            ...
            data:{roleid:'${role.id}'},
            dataType:'json',
            success:function (result) {  //result： 返回ztree所需要的格式（树节点的内容） 格式： [{id:1,name:'',pId:1,open:true,checked:true},{}]
